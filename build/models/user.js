...
var userStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO users (firstName,lastName,user_password) VALUES ($1, $2, $3) RETURNING *;';
                        hash = bcrypt_1.default.hashSync(user.user_password + PEPPER, parseInt(SALT_ROUNDS));
    ...
    userStore.prototype.authenticate = function (id, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, userPass, userInfo, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT user_password FROM users WHERE id=$1;';
                        return [4 /*yield*/, conn.query(sql, [id])];
                    case 2:
                        result = _a.sent();
                        if (!result.rows.length) return [3 /*break*/, 4];
                        userPass = result.rows[0].user_password;
                        if (!bcrypt_1.default.compareSync(password + PEPPER, userPass)) return [3 /*break*/, 4];
