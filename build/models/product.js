...
var productStore = /** @class */ (function () {
    ...
    productStore.prototype.createProduct = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO product (product_name,price) VALUES ($1, $2) RETURNING *;';
                        return [4 /*yield*/, conn.query(sql, [product.product_name, product.price,])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
