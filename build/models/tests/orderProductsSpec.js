...
var store = new orderProducts_1.orderProductsStore();
var oStore = new order_1.orderStore();
var uStore = new user_1.userStore;
var pStore = new product_1.productStore;
//test create user 
describe('orderProducts model database action', function () {
    var testUser = {
        firstName: 'usertest',
        lastName: 'test',
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdUser, createdProduct, conn, sql, createdOrder, orderProductsStore;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, store.createOrder(testOrderProduct)];
                case 5:
                    orderProductsStore = _a.sent();
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    conn = _a.sent();
                    sql = 'DELETE FROM orders; DELETE FROM users; DELETE FROM PRODUCT;DELETE FROM order_products;';
    ...
    it('should show order_product that just created', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.showOrder(testOrderProduct.id)];
                case 1:
                    result = _a.sent();
