...
//test create product 
describe('Product model database action', function () {
    var testProdcut = {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.createProduct(testProdcut)];
                case 1:
    ...
    it('should show that product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.showProduct(testProdcut.id)];
                case 1:
                    result = _a.sent();
                    console.log(result);
